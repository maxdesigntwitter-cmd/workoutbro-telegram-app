...
async function testApplication() {
  ...
  try {
    ...
    console.log('✅ Тестовая заявка отправлена админу!');
  } catch (error) {
