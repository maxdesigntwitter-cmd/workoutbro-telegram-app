...
// Запуск сервера
app.listen(PORT, () => {
  console.log(`🚀 Webhook bot server started on port ${PORT}`);
  console.log(`📡 Webhook URL: ${WEBHOOK_URL}/webhook`);
});

// Настройка webhook (только если указан WEBHOOK_URL)
if (process.env.WEBHOOK_URL) {
  ...
  console.log('⚠️  WEBHOOK_URL не указан, используйте polling режим');
